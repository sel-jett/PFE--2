<template>
	...
	<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
		...
		<form class="bg-white">
			...
			<p class="text-sm font-normal text-gray-600 mb-10">Welcome To NAJA7I</p>
			...
			<label for="input-group-1" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Email</label>
			...
			<select id="underline_select" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
				<option selected class="text-black">Choose a status</option>
				<option value="TE">Teacher</option>
				<option value="ST">Student</option>
			</select>
			
			<button type="submit" class="block w-full bg-blue-600 hover:bg-blue-400 transition duration-700 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Sign up</button>
			<span class="italic text-sm ml-2">Already a user?<Link href="/signin" class="text-sm ml-2 hover:text-blue-600 transition duration-700 cursor-pointer">Sign in</Link></span>
