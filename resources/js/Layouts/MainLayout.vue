  ...
  <body class="bg-blue-500">
	<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
		<Link class="text-3xl font-bold leading-none" href="/">
			<div><span class="text-blue-600">N</span>AJA7I</div>
    </Link>
		<div class="lg:hidden">
	...
	<div class="navbar-menu relative z-50 hidden">
      ...
      <!-- burger menu -->
			...
			<div class="mt-auto">
				<div class="pt-6">
					<Link class="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold bg-gray-50 hover:bg-gray-100 rounded-xl" href="">Sign in</Link>
					<Link class="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl" href="">Sign Up</Link>
				</div>
			</div>
		</nav>
	</div>
